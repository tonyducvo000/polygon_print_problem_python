...
############################## Middle ###################################
    #height should be n length,
    #length side to side should be max length
for row_index in range(0, top_half_height, 1):
    for star_index in range(0, max_length, 1):
        print("*", end=' ')
    print("")


############################## BOTTOM HALF ###################################
#row index is reset by this point
